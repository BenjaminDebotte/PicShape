    ...
    return (
        <div className="ui container">
            <div className="ui raised segment">
                <form onSubmit={this.handleProfileUpdate.bind(this)} className="ui form">
        ...
        <div className="ui raised segment">
            <form onSubmit={this.handleChangePassword.bind(this)} className="ui form">
        ...
        <div className="ui raised segment">
            ...
            <form onSubmit={this.handleDeleteAccount.bind(this)}  className="ui form">
